...
import { background, black, gray, greyHiglight, greylightwhite, primary, text, white, } from '../../styles/Variables';
...
export function AssetName(props: any): React.JSX.Element {
